...
def app():
    ...
    st.write(pd.DataFrame(tf_idf.toarray(),columns=tf_idf_vec.get_feature_names())[100:125].head(15))
    st.write(pd.DataFrame(tf_idf.toarray(),columns=tf_idf_vec.get_feature_names())[1000:1205].head(15))
